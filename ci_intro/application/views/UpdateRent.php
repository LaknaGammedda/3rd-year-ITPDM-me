...
<?php echo  form_open_multipart('renterlists/UpdateRentouts($id)'); ?>
  ...
  <div class="form-group">
    ...
    <input style="width:300px;height:35px" type="text" value="<?php echo $UpdatedData[0]->Address2; ?>" class="form-control" name="address2"/>
  </div>
  <div class="form-group">
    <label>City:</label>
    <input style="width:300px;height:35px" type="text" value="<?php echo $UpdatedData[0]->Destination; ?>" class="form-control" name="city"/>
  </div>
  <div class="form-group">
    <label>Price:</label>
    <input style="width:300px;height:35px"type="text" value="<?php echo $UpdatedData[0]->Price; ?>" class="form-control" name="price"/>
  </div>
<div class="form-group">
  <label>Lodge Name :</label>
  <input style="width:300px;height:35px"type="text" value="<?php echo $UpdatedData[0]->LodgeName; ?>" class="form-control" name="lname"/>
</div>
    <div class="form-group">
